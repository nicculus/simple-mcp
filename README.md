...
| [`cli/npm/`](cli/npm/) | Launcher wrapping `client/js`'s CLI as `smcp` | [`@nicculus/simplemcp`](https://www.npmjs.com/package/@nicculus/simplemcp) on npm |
| [`cli/python/`](cli/python/) | Launcher wrapping `client/python`'s CLI as `smcp` | [`nicculus-simplemcp`](https://pypi.org/project/nicculus-simplemcp/) on PyPI |
