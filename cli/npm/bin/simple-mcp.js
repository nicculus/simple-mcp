...
try {
  ...
  console.error("simple-mcp: could not locate @nicculus/mcp-client — is it installed?");
...
if (result.error) {
  console.error(`simple-mcp: failed to launch mcp-client (${result.error.message})`);
  process.exit(1);
}
